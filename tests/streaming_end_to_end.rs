...
mod tests {
    ...
    fn test_streaming_state_consistency() {
        ...
        let _output1 = attention1.forward(input_x_chunk1, None, true, false, false, false, None, false, false);
        ...
        let output2_from_loaded_state = attention2.forward(input_x_chunk2.clone(), None, false, true, false, false, None, false, false);
        
        // Compare with original instance processing chunk 2
        let output2_from_original = attention1.forward(input_x_chunk2, None, false, true, false, false, None, false, false);
    ...
    fn test_state_roundtrip_validation() {
        ...
        let original_output = attention.forward(dummy_input.clone(), None, true, false, false, false, None, false, false);
        ...
        let mut attention_loaded = MultiHeadAttention::<TestBackend>::new(
            ...
            None, // precomputed_kv
            true, // deterministic_init
            Some(99), // init_seed - Different seed to ensure loading works
            true, // inference_mode
        );
        ...
        let loaded_output = attention_loaded.forward(dummy_input.clone(), None, false, true, false, false, None, false, false);
